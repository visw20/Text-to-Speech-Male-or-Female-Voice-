...
engine.setProperty('voice', voices[1].id)  # Use voices[1] for female voice 0 for male voice
...
save_path = r"C:\Text-to-Speech(Male and Female Voice)\output_female_voice.mp3"
